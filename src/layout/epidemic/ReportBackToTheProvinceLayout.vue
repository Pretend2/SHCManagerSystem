    ...
    <div style="padding: 0 10px">
        <n-card title="查询条件" style="margin-top: 10px">
            <n-space item-style="display: flex; align-item: center;">
                <n-input type="text" placeholder="请输入姓名" />
                <n-input type="text" placeholder="请输入省份证" />
                <n-input type="text" placeholder="请输入手机号" />
                <n-select style="width: 180px" placeholder="请选择来源地" :options="options" />
        ...
        <n-card title="返省信息" style="margin-top: 10px;padding: 0; margin-bottom: 10px;">
...
<script>
export default {
    name: 'ReportBackToTheProvinceLayout'
}
</script>
