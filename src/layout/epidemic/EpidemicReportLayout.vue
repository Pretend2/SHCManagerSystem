    ...
    <div style="padding: 0 10px">
        <n-card title="查询条件" style="margin-top: 10px">
            <n-space item-style="display: flex; align-item: center;">
                <n-select style="width: 180px" placeholder="请选择项目名称" :options="options" />
                <n-input type="text" placeholder="请输入题目" />
                <n-input type="text" placeholder="请输入内容" />
        ...
        <n-card title="疫情上报" style="margin-top: 10px;padding: 0; margin-bottom: 10px;">
