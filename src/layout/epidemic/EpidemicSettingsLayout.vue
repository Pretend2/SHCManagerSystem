    ...
    <div style="padding: 0 10px">
        <n-card title="查询条件" style="margin-top: 10px">
            <n-space item-style="display: flex; align-item: center;">
                ...
                <!-- <n-select style="width: 180px" placeholder="" :options="options" /> -->
                <n-input type="text" placeholder="请输入项目ID" />
        ...
        <n-card title="项目信息" style="margin-top: 10px;padding: 0; margin-bottom: 10px;">
                    ...
                    <tr v-for="index in 10" :key="index">
                        ...
                        <td style="width: 160px">
                            <n-button-group size="large">
                                <n-button size="small">题目</n-button>
