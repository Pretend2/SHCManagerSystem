    ...
    <div style="padding: 0 10px">
        <n-card title="查询条件" style="margin-top: 10px">
            <n-space item-style="display: flex; align-item: center;">
                <n-input type="text" placeholder="请输入停车场编号" />
                <n-select style="width: 180px" placeholder="请选择停车场类型" :options="options" />
                <n-input type="text" placeholder="请输入停车场ID" />
        ...
        <n-card title="停车场信息" style="margin-top: 10px;padding: 0; margin-bottom: 10px;">
