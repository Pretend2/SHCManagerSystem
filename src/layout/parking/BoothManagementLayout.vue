    ...
    <div style="padding: 0 10px">
        <n-card title="查询条件" style="margin-top: 10px">
            <n-space item-style="display: flex; align-item: center;">
                <n-input type="text" placeholder="请输入岗亭编号" />
                <n-input type="text" placeholder="请输入岗亭名称" />
                <n-select style="width: 180px" placeholder="请选择临时车进场" :options="options" />
        ...
        <n-card title="岗亭信息" style="margin-top: 10px;padding: 0; margin-bottom: 10px;">
                    ...
                    <tr v-for="index in 10" :key="index">
                        ...
                        <td>
                            <n-button-group size="large">
                                <n-button size="small">共享岗亭</n-button>
