    ...
    <div style="padding: 0 10px">
        <n-card title="查询条件" style="margin-top: 10px">
            <n-space item-style="display: flex; align-item: center;">
                <n-input type="text" placeholder="请输入设备名称" />
                <n-input type="text" placeholder="请输入位置编码" />
                <n-select style="width: 180px" placeholder="请选择位置类型" :options="options" />
        ...
        <n-card title="设备位置" style="margin-top: 10px;padding: 0; margin-bottom: 10px;">
