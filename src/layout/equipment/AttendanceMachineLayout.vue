    ...
    <div style="padding: 0 10px">
        <n-card title="查询条件" style="margin-top: 10px">
            <n-space item-style="display: flex; align-item: center;">
                <n-input type="text" placeholder="请输入考勤机编码" />
                <n-input type="text" placeholder="请输入考勤机名称" />
        ...
        <n-card title="考勤机信息" style="margin-top: 10px;padding: 0; margin-bottom: 10px;">
