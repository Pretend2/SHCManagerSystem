    ...
    <div style="padding: 0 10px">
        <n-card title="查询条件" style="margin-top: 10px">
            <n-space item-style="display: flex; align-item: center;">
                <n-select style="width: 180px" placeholder="请选择设备类型" :options="options" />
                <n-input type="text" placeholder="请输入设备类型名称" />
        ...
        <n-card title="设备类型" style="margin-top: 10px;padding: 0; margin-bottom: 10px;">
