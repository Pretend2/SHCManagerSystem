...
export default defineComponent({
    ...
    setup(props, context) {
        ...
        const defaultData = {
            ...
            identifyCodes: '1234567890ABCDEFGHIJKMLNOPQRSTUVWSYZabcdefghijkmlnopqrstuvwsyz', // 生成验证码的元素，可以加入字母
        ...
        const makeCode = () => {
            ...
            drawPic()
            // 返回加密后的图片验证码值
            context.emit('getCode', md5(defaultData.identifyCode.toLowerCase()))
        }
